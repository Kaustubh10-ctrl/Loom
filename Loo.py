...
save_path = "/home/dani/Desktop/jar/data"
model = load_model(os.path.join(save_path,"chatbot0.h5"))
vocab = pickle.load( open( os.path.join(save_path,"vocab0.pkl"), "rb" ) )
...
while True:
    ...
    while True:
        ...
        try:
            ...
            print('bad word in either story or question:', sys.exc_info()[1],'<--')